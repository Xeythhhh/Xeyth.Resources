...
XPSRequireCommand bat "e.g. 'scoop install bat' `nYou can use scoop, choco or winget for windows`nFor other environments check https://github.com/sharkdp/bat?tab=readme-ov-file#installation"

# Set cat alias to use bat for better syntax highlighting
Set-Alias cat bat -Force

# Register argument completer for bat command
Register-ArgumentCompleter -Native -CommandName 'bat' -ScriptBlock {
	...
	# Build command string for switch statement
	...
	# Define completions based on command context
